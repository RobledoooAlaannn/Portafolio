  ...
  return (
    <div className="contenedorPerfil">
      ...
      <div className="descripcion">
        <p>
          ¡Hola! Soy Alan, un apasionado de la informática con 22 años de edad y
          en camino de convertirme en Analista en Sistemas. Actualmente estoy
          cursando la Licenciatura en Informática en la prestigiosa Universidad
          Nacional del Oeste. Estoy emocionado de compartir mi trayectoria
          contigo. Me encuentro en la etapa final de mi carrera, a solo dos
          materias de obtener mi título de Analista en Sistemas, lo que
          demuestra mi dedicación y compromiso con la excelencia académica. Mi
          formación académica me ha proporcionado una sólida base en
          programación, diseño de sistemas y resolución de problemas,
          habilidades que estoy ansioso por aplicar en proyectos del mundo real.
          Además de mi pasión por la informática, tengo diversos intereses que
          enriquecen mi vida. Uno de mis hobbies favoritos es el boxeo, donde
          encuentro una forma de mantenerme en forma física y mentalmente. Creo
          firmemente que esta diversidad de intereses me proporciona una
          perspectiva única y habilidades transferibles que pueden beneficiar mi
          trabajo como programador. Estoy emocionado de seguir creciendo
          profesionalmente y enfrentar nuevos desafíos en el mundo de la
          tecnología. ¡Espero poder compartir mi experiencia y contribuir al
          éxito de futuros proyectos! ¡Gracias por visitar mi portafolio!
        ...
        >
          <div class="modalInfo">
            ...
            <ul>
              ...
              <li>Leer libros de crecimiento personal o de ciencia ficcion</li>
            </ul>
